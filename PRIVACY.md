...
**Effective date:** September 20, 2026 (updated for Astra3 1.9.0)
...
| Data API (data.rcsb.org) | When a report is created for a structure downloaded by PDB ID, to add validation, reference-sequence and domain information | The PDB ID and the chain identifiers being analyzed |
...
Astra3 never uploads your imported files, your results, your reports, or your settings anywhere. Structures you import from your own files are never looked up online.

Reports contain links to UniProt (uniprot.org) for reference sequences. Nothing is sent to UniProt unless you click one of those links, which opens it in your web browser.
