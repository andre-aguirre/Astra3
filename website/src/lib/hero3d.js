...
const STRUCTURES = [
  // The 1ERJ and 8EFU copies are rigidly rotated (no mirroring) so the
  // propeller faces the viewer and the fibril axis stands upright.
  { file: 'models/1erj-c.pdb', label: 'PDB 1ERJ · TUP1 WD40 DOMAIN', axis: 'z', speed: 0.35 },
  { file: 'models/1ake-a.pdb', label: 'PDB 1AKE · ADENYLATE KINASE', axis: 'y', speed: 0.45 },
  { file: 'models/8efu.pdb', label: 'PDB 8EFU · PRION PROTEIN FIBRIL', axis: 'y', speed: 0.45 },
];
